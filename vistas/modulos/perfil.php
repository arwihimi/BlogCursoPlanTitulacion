                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <img class="profile-user-img img-fluid img-circle" src="<?= BASE_URL . $_SESSION['imagen'] ?>" alt="User profile picture">
                        </div>
                            ...
                            <?php foreach ($preguntas as $pregunta): ?>
                                <div class="post">
                                    <div class="user-block">
                                        <img class="img-circle img-bordered-sm" src="<?= BASE_URL . $_SESSION['imagen'] ?>" alt="user image">
                                        <span class="username">
